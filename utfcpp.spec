...
Version  : 4.0.6
Release  : 17
URL      : https://github.com/nemtrif/utfcpp/archive/v4.0.6/utfcpp-4.0.6.tar.gz
Source0  : https://github.com/nemtrif/utfcpp/archive/v4.0.6/utfcpp-4.0.6.tar.gz
...
%prep
%setup -q -n utfcpp-4.0.6
cd %{_builddir}/utfcpp-4.0.6
pushd ..
cp -a utfcpp-4.0.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730734309
mkdir -p clr-build
pushd clr-build
...
export GOAMD64=v2
%cmake .. -DUTF8_TESTS=OFF  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
pushd ../buildavx2/
