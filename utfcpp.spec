...
Version  : 4.0.3
Release  : 14
URL      : https://github.com/nemtrif/utfcpp/archive/v4.0.3/utfcpp-4.0.3.tar.gz
Source0  : https://github.com/nemtrif/utfcpp/archive/v4.0.3/utfcpp-4.0.3.tar.gz
...
%prep
%setup -q -n utfcpp-4.0.3
cd %{_builddir}/utfcpp-4.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701725469
mkdir -p clr-build
pushd clr-build
